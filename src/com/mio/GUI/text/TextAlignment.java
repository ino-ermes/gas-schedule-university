...
public enum TextAlignment {
     ...
     *
     * @return	true if the text alignment is aligned to the bottom; otherwise,
     * false
     */
     ...
     *
     * @return	true if the text alignment is horizontally centered; otherwise,
     * false
     */
     ...
     *
     * @return	true if the text alignment is aligned to the left; otherwise,
     * false
     */
     ...
     *
     * @return	true if the text alignment is aligned to the middle; otherwise,
     * false
     */
     ...
     *
     * @return	true if the text alignment is aligned to the right; otherwise,
     * false
     */
     ...
     *
     * @return	true if the text alignment is aligned to the top; otherwise,
     * false
     */
